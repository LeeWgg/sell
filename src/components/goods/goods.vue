<template>
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods" :key="item.name" class="menu_item" :class="{'current': currentIndex === index}" @click="selectMenu(index)">
    ...
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="item in goods" :key="item.name" class="food-list food-list-hook">
          ...
          <ul>
            <li v-for="food in item.foods" :key="food.name" class="food-item border-1px" @click="selectFood(food)">
              <div class="icon">
